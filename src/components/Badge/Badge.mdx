...
The **animation** prop is used to specify the animation of the badge. In the example above, it is set to _false_, which will apply the default animation to the badge.

### class(optional)

The **class** prop is used to specify the class of the badge.
...
<Canvas>
  ...
  <Story of={BadgeStories.Overlap} />
  <Story of={BadgeStories.Outside} />
  <Story of={BadgeStories.WithAnimation} />
</Canvas>
