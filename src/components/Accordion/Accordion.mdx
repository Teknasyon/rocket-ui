...
The **multiple** prop is a boolean that determines whether multiple panels can be expanded at the same time. A value of true indicates that multiple panels can be expanded, and a value of false indicates that only one panel can be expanded at a time.
...
<Canvas>
  <Story of={AccordionStories.Accordions} />
</Canvas>

<Canvas>
  <Story of={AccordionStories.AccordionsMultipleOpen} />
</Canvas>
