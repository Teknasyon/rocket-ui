...
To access a comprehensive list of icons available in our design system, please refer to the icon list page by clicking [the following link](https://fonts.google.com/icons?icon.set=Material+Icons\&icon.style=Rounded).
...
<Canvas>
  <Story of={IconStories.DefaultIcon} />
</Canvas>
